	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"Piranhas are more " + adjective + " during the day,\n so cross the"
						+ " river at night. Piranhas are attracted to fresh " + liquid + " and will most \n likely"
						+ " take a bite out of your " + bodypart + " if you " + verb + ". Whatever you do, if you \n"
						+ "have an open wound, try to find another way to getback to the " + place + ". Good luck!");
